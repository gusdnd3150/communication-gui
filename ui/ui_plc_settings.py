...
class Ui_PLC_Settings(object):
    def setupUi(self, MainWindow):
        ...
        self.list_sk.setGeometry(QRect(0, 40, 801, 451))
        font1 = QFont()
        ...
        self.list_sk.setSelectionBehavior(QAbstractItemView.SelectItems)
        ...
        self.list_sk_2 = QTableWidget(self.tab_3)
        if (self.list_sk_2.columnCount() < 1):
            self.list_sk_2.setColumnCount(1)
        __qtablewidgetitem1 = QTableWidgetItem()
        self.list_sk_2.setHorizontalHeaderItem(0, __qtablewidgetitem1)
        self.list_sk_2.setObjectName(u"list_sk_2")
        self.list_sk_2.setGeometry(QRect(0, 40, 801, 451))
        self.list_sk_2.setFont(font1)
        self.list_sk_2.setProperty(u"showDropIndicator", False)
        self.list_sk_2.setDragEnabled(False)
        self.list_sk_2.setDragDropOverwriteMode(False)
        self.list_sk_2.setSelectionBehavior(QAbstractItemView.SelectItems)
    ...
    def retranslateUi(self, MainWindow):
        ...
        ___qtablewidgetitem1 = self.list_sk_2.horizontalHeaderItem(0)
