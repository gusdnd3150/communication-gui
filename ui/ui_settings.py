...
class Ui_Settings(object):
    def setupUi(self, MainWindow):
        ...
        self.list_sk.setGeometry(QRect(0, 40, 801, 461))
        font1 = QFont()
        font1.setFamilies([u"\ub9d1\uc740 \uace0\ub515"])
        font1.setPointSize(9)
        font1.setBold(True)
        self.list_sk.setFont(font1)
        self.list_sk.setProperty(u"showDropIndicator", False)
        self.list_sk.setDragEnabled(False)
        self.list_sk.setDragDropOverwriteMode(False)
        self.list_sk.setSelectionBehavior(QAbstractItemView.SelectionBehavior.SelectRows)
        self.label_4 = QLabel(self.tab)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(10, 10, 53, 22))
        self.sk_search_pkg = QLineEdit(self.tab)
        self.sk_search_pkg.setObjectName(u"sk_search_pkg")
        self.sk_search_pkg.setGeometry(QRect(40, 10, 71, 22))
        self.label_5 = QLabel(self.tab)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setGeometry(QRect(120, 10, 41, 22))
        self.sk_search_sk = QLineEdit(self.tab)
        self.sk_search_sk.setObjectName(u"sk_search_sk")
        self.sk_search_sk.setGeometry(QRect(160, 10, 111, 22))
        ...
        self.list_in.setGeometry(QRect(0, 40, 801, 461))
        self.list_in.setFont(font1)
        self.list_in.setTabKeyNavigation(False)
        self.list_in.setProperty(u"showDropIndicator", False)
        self.list_in.setDragDropOverwriteMode(False)
        self.list_in.setSelectionBehavior(QAbstractItemView.SelectionBehavior.SelectRows)
        ...
        self.label_73.setGeometry(QRect(120, 10, 61, 22))
        self.in_search_pkg = QLineEdit(self.tab_5)
        self.in_search_pkg.setObjectName(u"in_search_pkg")
        self.in_search_pkg.setGeometry(QRect(40, 10, 71, 22))
        self.label_74 = QLabel(self.tab_5)
        self.label_74.setObjectName(u"label_74")
        self.label_74.setGeometry(QRect(10, 10, 53, 22))
        self.in_search_sk = QLineEdit(self.tab_5)
        self.in_search_sk.setObjectName(u"in_search_sk")
        self.in_search_sk.setGeometry(QRect(180, 10, 111, 22))
        ...
        self.msg_list.setSelectionMode(QAbstractItemView.SelectionMode.SingleSelection)
        self.msg_list.setSelectionBehavior(QAbstractItemView.SelectionBehavior.SelectRows)
        ...
        self.msg_dt_list.setSelectionMode(QAbstractItemView.SelectionMode.SingleSelection)
        self.msg_dt_list.setSelectionBehavior(QAbstractItemView.SelectionBehavior.SelectRows)
        ...
        self.list_bz.setSelectionBehavior(QAbstractItemView.SelectionBehavior.SelectRows)
        ...
        self.list_sch.setSelectionBehavior(QAbstractItemView.SelectionBehavior.SelectRows)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"SK_ID", None))
        ...
        self.label_73.setText(QCoreApplication.translate("MainWindow", u"IN_SK_ID", None))
        self.label_74.setText(QCoreApplication.translate("MainWindow", u"PKG", None))
